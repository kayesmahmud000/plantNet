...
const AdminStatistics = () => {
  ...
  const {totalPlants, totalUsers,  orderDetails, chartData}=states
  console.log(totalPlants, totalUsers, orderDetails, chartData)
